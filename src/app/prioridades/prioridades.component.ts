...
export class PrioridadesComponent implements OnInit {
  ...
  obtenPrioridades() {
    this.http.post(this.servidor.ip + '/buzon_backend/obtenPrioridades.php', JSON.stringify({
      tkn: this.token
    }), {
      }).subscribe(res => {
        if (res['Error']) {
  ...
  altaPrioridad() {
    ...
    this.http.post(this.servidor.ip + '/buzon_backend/altaPrioridad.php', JSON.stringify({
      tkn: this.token, prioridad: this.nueva_prioridad
    }), {
      }).subscribe(res => {
        if (res['Error']) {
          Swal.fire({
  ...
  saveEditable(prioridad, campo) {
    ...
    this.http.post(this.servidor.ip + '/buzon_backend/editaPrioridad.php', JSON.stringify({
      tkn: this.token, prioridad: prioridad, campo: campo
    }), {
      }).subscribe(res => {
        if (res['Error']) {
          Swal.fire({
  ...
  cambiaEstado(prioridad, evento) {
    ...
    this.http.post(this.servidor.ip + '/buzon_backend/cambiaEstadoPrioridad.php', JSON.stringify({
      tkn: this.token, prioridad: prioridad
    }), {
      }).subscribe(res => {
        if (res['Error']) {
          Swal.fire({
